    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < categoriesList.length; j++) {
            if (numOfBatchesC[j] > 0) {
                ...
                double avgFee = totFeeC[j] / totQuantityC[j];
                double avgNetProfit = (totFeeC[j] - totLaborCostC[j] - totAsmCostC[j]) / totQuantityC[j];
